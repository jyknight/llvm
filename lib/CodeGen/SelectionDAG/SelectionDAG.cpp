...
SDValue SelectionDAG::getExternalSymbol(const char *Sym, EVT VT) {
  if(!Sym)
    report_fatal_error("Attempted to use null symbol in SelectionDAG::getExternalSymbol!");
...
SDValue SelectionDAG::getTargetExternalSymbol(const char *Sym, EVT VT,
                                              unsigned char TargetFlags) {
  if(!Sym)
    report_fatal_error("Attempted to use null symbol in SelectionDAG::getTargetExternalSymbol!");
